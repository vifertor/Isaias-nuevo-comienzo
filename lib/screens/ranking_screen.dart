...
class _RankingScreenState extends State<RankingScreen> with SingleTickerProviderStateMixin {
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(colors: [AppColors.primaryPurple.withOpacity(0.3), AppColors.darkBg], begin: Alignment.topCenter, end: Alignment.bottomCenter),
              ),
              ...
              child: Column(
                children: [
                  ...
                  Text('Compete with students worldwide', style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 13, fontWeight: FontWeight.w600)),
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          // Rest of list
          ...rest.asMap().entries.map((e) => _buildRankRow(e.value)).toList(),
  ...
  Widget _buildRankRow(RankingEntry entry) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: entry.isCurrentUser ? AppColors.primaryPurple.withOpacity(0.2) : AppColors.darkCard,
        borderRadius: BorderRadius.circular(18),
        border: Border.all(color: entry.isCurrentUser ? AppColors.primaryPurple.withOpacity(0.5) : Colors.white.withOpacity(0.06)),
        boxShadow: entry.isCurrentUser ? [BoxShadow(color: AppColors.primaryPurple.withOpacity(0.2), blurRadius: 12)] : [],
      ),
      child: Row(
        children: [
          SizedBox(width: 28, child: Text('#${entry.rank}', style: TextStyle(color: entry.isCurrentUser ? AppColors.primaryPurple : Colors.white.withOpacity(0.5), fontWeight: FontWeight.w800, fontSize: 14))),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Text(entry.name, style: TextStyle(color: entry.isCurrentUser ? Colors.white : Colors.white.withOpacity(0.85), fontWeight: FontWeight.w800, fontSize: 14)),
                ...
                Text('Level ${entry.level} · ${entry.xp} XP', style: TextStyle(color: Colors.white.withOpacity(0.45), fontSize: 11, fontWeight: FontWeight.w600)),
              ],
            ),
          ),
