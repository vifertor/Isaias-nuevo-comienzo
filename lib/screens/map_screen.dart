            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: level.unlocked
                    ? [worldColor, worldColor.withOpacity(0.3)]
                      ...
                      AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: level.completed
                              ? LinearGradient(
                                  colors: [worldColor, worldColor.withOpacity(0.6)],
                                )
                              : level.unlocked
                                  ? LinearGradient(
                                      colors: [
                                        worldColor.withOpacity(0.4),
                          ...
                          boxShadow: level.unlocked
                              ? [
                                  BoxShadow(
                                    color: worldColor.withOpacity(
                                        level.completed ? 0.5 : 0.2),
