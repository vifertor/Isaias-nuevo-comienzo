...
/// ROOM 3 — Listening: Read transcript, answer multiple choice questions
...
class _EscapeRoomRoom3State extends State<EscapeRoomRoom3>
  ...
  final String _transcript =
      '"Attention passengers: Flight GA-301 to London will DEPART from Gate B7 in 10 minutes. '
      'Passengers must present their PASSPORT and BOARDING PASS at the gate. '
      'If you have any LUGGAGE to check, please proceed to Desk 3 IMMEDIATELY."';
  ...
  void _play() {
    ...
    Future.delayed(const Duration(seconds: 5), () {
      if (mounted) setState(() { _isPlaying = false; _revealed = true; });
    });
  }
        ...
        children: [
          ...
          DialogueScene(
            ...
            message: _submitted
                ...
                : _revealed
                    ? 'Now read the transcript carefully and answer the 3 questions below. You can play it again!'
          ...
          if (_revealed) ...[
                ...
                children: [
                  const Row(
                    children: [
                      ...
                      SizedBox(width: 6),
                      Text('Transcript:', style: TextStyle(color: Colors.white70, fontWeight: FontWeight.w800, fontSize: 13)),
                    ],
                  ),
                  const SizedBox(height: 8),
                  Text(
                    _transcript,
                    style: const TextStyle(color: Colors.white, fontSize: 13, height: 1.6, fontStyle: FontStyle.italic),
                  ),
                ],
              ),
            ),
            ...
            if (!_submitted)
              ...
              ERNextButton(
                label: '🔓 Unlock Final Room!',
                color: const Color(0xFFA855F7),
                onTap: () => widget.onComplete('${_correct}C'),
              ),
            ],
          ] else ...[
    ...
    return Container(
      ...
      child: Column(
        children: [
            ...
            children: [
              ...
              const Column(
                ...
                children: [
                  ...
                  Text('GA-301 • Gate B7', style: TextStyle(color: Colors.white54, fontSize: 11)),
                ],
              ),
              const Spacer(),
              // Play/Stop button
          ...
          const SizedBox(height: 8),
          Text(
            _isPlaying ? '🔊 Playing...' : _revealed ? '▶ Play again' : '▶ PRESS TO PLAY',
