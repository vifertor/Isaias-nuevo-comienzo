                  ...
                  return Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        child: Text(f, style: TextStyle(color: selected ? Colors.white : Colors.white.withOpacity(0.5), fontWeight: FontWeight.w700, fontSize: 13)),
                      ),
                    ),
                  );
                }).toList(),
      ...
      itemBuilder: (context, i) {
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(color: AppColors.darkCard, borderRadius: BorderRadius.circular(20), border: Border.all(color: Colors.white.withOpacity(0.07))),
            child: Row(
              children: [
                Stack(
                  children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Level ${s.level} · ${s.missionsCompleted} missions done', style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 12)),
                ...
                Column(
                  children: [
                    ...
                    Text('${s.lastActive}d ago', style: TextStyle(color: Colors.white.withOpacity(0.35), fontSize: 10, fontWeight: FontWeight.w600)),
                  ],
                ),
              ],
            ),
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: [AppColors.primaryPurple.withOpacity(0.2), AppColors.darkCard], begin: Alignment.topLeft, end: Alignment.bottomRight),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Level ${student.level}', style: TextStyle(color: Colors.white.withOpacity(0.6), fontSize: 13)),
                      const SizedBox(height: 8),
                      Row(
                        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                ClipRRect(borderRadius: BorderRadius.circular(6), child: LinearProgressIndicator(value: student.completionPercent, minHeight: 12, backgroundColor: Colors.white.withOpacity(0.08), valueColor: const AlwaysStoppedAnimation<Color>(AppColors.primaryPurple))),
              ],
            ),
          ),
          const SizedBox(height: 16),
          ...
          Row(
            children: [
              Expanded(child: Container(
                ...
                decoration: BoxDecoration(color: AppColors.accentGreen.withOpacity(0.12), borderRadius: BorderRadius.circular(16), border: Border.all(color: AppColors.accentGreen.withOpacity(0.3))),
              ...
              Expanded(child: Container(
                padding: const EdgeInsets.all(14),
                decoration: BoxDecoration(color: AppColors.accentOrange.withOpacity(0.12), borderRadius: BorderRadius.circular(16), border: Border.all(color: AppColors.accentOrange.withOpacity(0.3))),
                child: Column(children: [
                  const Text('🎯', style: TextStyle(fontSize: 24)),
                  const SizedBox(height: 6),
          ...
          ...skills.map((s) => Padding(
            ...
            child: Container(
              padding: const EdgeInsets.all(14),
              decoration: BoxDecoration(color: AppColors.darkCard, borderRadius: BorderRadius.circular(16), border: Border.all(color: (s['color'] as Color).withOpacity(0.2))),
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 6),
                        ClipRRect(borderRadius: BorderRadius.circular(4), child: LinearProgressIndicator(value: s['value'] as double, minHeight: 8, backgroundColor: (s['color'] as Color).withOpacity(0.1), valueColor: AlwaysStoppedAnimation<Color>(s['color'] as Color))),
                      ],
                    ),
                  ),
                ],
