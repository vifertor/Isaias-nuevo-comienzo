                  ...
                  children: [
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: _bgColors[_selectedColorIndex]
                                    .withOpacity(_previewGlow.value),
                                blurRadius: 40,
                                spreadRadius: 15,
                              ),
                            ],
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: _bgColors[_selectedColorIndex].withOpacity(0.7),
                          width: 3,
                        ),
                      ),
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color: _bgColors[_selectedColorIndex].withOpacity(0.3),
                        ),
                        child: Center(
                          child: Text(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: selected
                                    ? [
                                        BoxShadow(
                                          color: _bgColors[i].withOpacity(0.6),
                                          blurRadius: 12,
                                          spreadRadius: 2,
                                        ),
                                      ]
