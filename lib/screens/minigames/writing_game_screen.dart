          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [AppColors.writingColor.withOpacity(0.15), AppColors.darkBg, AppColors.darkBg],
                  ...
                  child: Row(
                    children: [
                      GestureDetector(
                        ...
                        child: Container(padding: const EdgeInsets.all(10), decoration: BoxDecoration(color: Colors.white.withOpacity(0.1), borderRadius: BorderRadius.circular(12)), child: const Icon(Icons.close_rounded, color: Colors.white, size: 20)),
                      ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(color: AppColors.writingColor.withOpacity(0.2), borderRadius: BorderRadius.circular(14), border: Border.all(color: AppColors.writingColor.withOpacity(0.4))),
                      ...
                      return Expanded(
                        child: GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            child: Text(_gameModes[i], textAlign: TextAlign.center, style: TextStyle(color: selected ? Colors.white : Colors.white.withOpacity(0.4), fontWeight: FontWeight.w800, fontSize: 12)),
                          ),
                        ),
                      );
                    }),
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Text('Unscramble the letters!', style: TextStyle(color: Colors.white.withOpacity(0.6), fontSize: 14)),
              const SizedBox(height: 20),
              // Answer display
              Container(
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(color: AppColors.darkBg, borderRadius: BorderRadius.circular(16), border: Border.all(color: AppColors.writingColor.withOpacity(0.3))),
                child: Text(
                  _userInput.isEmpty ? '_ ' * (word['answer'] as String).length : _userInput,
                  style: TextStyle(color: _userInput.isEmpty ? Colors.white.withOpacity(0.3) : Colors.white, fontSize: 28, fontWeight: FontWeight.w900, letterSpacing: 4),
                ),
              ),
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        boxShadow: [BoxShadow(color: AppColors.writingColor.withOpacity(0.4), blurRadius: 8, offset: const Offset(0, 4))],
                      ),
                ...
                children: [
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(padding: const EdgeInsets.all(14), decoration: BoxDecoration(color: Colors.white.withOpacity(0.08), borderRadius: BorderRadius.circular(14)),
      ...
      builder: (context, innerSetState) {
        return Column(
          children: [
            Container(
              padding: const EdgeInsets.all(24),
              decoration: BoxDecoration(color: AppColors.darkCard, borderRadius: BorderRadius.circular(24), border: Border.all(color: AppColors.writingColor.withOpacity(0.3))),
              child: Column(
                children: [
                  Text(item['emoji'] as String, style: const TextStyle(fontSize: 60)),
                  const SizedBox(height: 16),
                  Text(item['sentence'] as String, textAlign: TextAlign.center, style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
                  const SizedBox(height: 24),
                    ...
                    return Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          padding: const EdgeInsets.all(16),
                          decoration: BoxDecoration(
                            color: _selected == e.key ? AppColors.writingColor.withOpacity(0.2) : AppColors.darkBg,
                            borderRadius: BorderRadius.circular(16),
                            border: Border.all(color: _selected == e.key ? AppColors.writingColor : Colors.white.withOpacity(0.1)),
                          ),
                          child: Row(
                            children: [
                              Container(width: 28, height: 28, decoration: BoxDecoration(color: AppColors.writingColor.withOpacity(0.2), shape: BoxShape.circle),
                                child: Center(child: Text(String.fromCharCode(65 + e.key), style: const TextStyle(color: AppColors.writingColor, fontWeight: FontWeight.w800, fontSize: 13)))),
                              const SizedBox(width: 12),
                              Text(e.value, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 16)),
                            ],
                          ),
                        ),
                      ),
          ...
          child: Column(
            children: [
              Container(
                ...
                decoration: BoxDecoration(color: AppColors.writingColor.withOpacity(0.1), shape: BoxShape.circle, border: Border.all(color: AppColors.writingColor.withOpacity(0.3), width: 3)),
                child: Center(child: Text(item['emoji'] as String, style: const TextStyle(fontSize: 64))),
              ),
              const SizedBox(height: 16),
              Text(item['hint'] as String, style: TextStyle(color: Colors.white.withOpacity(0.6), fontSize: 14, fontWeight: FontWeight.w600)),
              const SizedBox(height: 20),
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(color: Colors.white.withOpacity(0.2), letterSpacing: 4, fontSize: 22),
