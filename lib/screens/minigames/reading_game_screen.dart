          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [AppColors.readingColor.withOpacity(0.15), AppColors.darkBg, AppColors.darkBg],
                    ...
                    children: List.generate(_questions.length, (i) => Expanded(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: i <= _questionIndex ? null : Colors.white.withOpacity(0.1),
                      ...
                      children: [
                        ScaleTransition(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(colors: [AppColors.readingColor.withOpacity(0.2), AppColors.darkCard], begin: Alignment.topCenter, end: Alignment.bottomCenter),
                              borderRadius: BorderRadius.circular(28),
                              border: Border.all(color: AppColors.readingColor.withOpacity(0.3), width: 2),
                            ),
                            child: Column(
                              children: [
                                Container(
                                  width: 140, height: 140,
                                  decoration: BoxDecoration(color: AppColors.readingColor.withOpacity(0.1), shape: BoxShape.circle, border: Border.all(color: AppColors.readingColor.withOpacity(0.3), width: 3)),
