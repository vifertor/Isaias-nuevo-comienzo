          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [AppColors.listeningColor.withOpacity(0.15), AppColors.darkBg, AppColors.darkBg],
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(color: AppColors.listeningColor.withOpacity(0.2), borderRadius: BorderRadius.circular(14), border: Border.all(color: AppColors.listeningColor.withOpacity(0.4))),
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(colors: [AppColors.listeningColor.withOpacity(0.25), AppColors.darkCard], begin: Alignment.topCenter, end: Alignment.bottomCenter),
                            borderRadius: BorderRadius.circular(28),
                            border: Border.all(color: AppColors.listeningColor.withOpacity(0.4), width: 2),
                          ),
                          child: Column(
                            children: [
                              Text(q['emoji'] as String, style: const TextStyle(fontSize: 80)),
                              const SizedBox(height: 12),
                              Text('Listen and identify', style: TextStyle(color: Colors.white.withOpacity(0.6), fontSize: 14, fontWeight: FontWeight.w600)),
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      boxShadow: [BoxShadow(color: AppColors.listeningColor.withOpacity(0.6), blurRadius: 20, spreadRadius: _isPlaying ? 5 : 0)],
                                    ),
                              ...
                              const SizedBox(height: 12),
                              Text(_isPlaying ? 'Playing...' : 'Tap to play', style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 13, fontWeight: FontWeight.w600)),
                              if (_isPlaying) ...[
                                const SizedBox(height: 16),
                                Container(
                                  padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 10),
                                  decoration: BoxDecoration(color: AppColors.listeningColor.withOpacity(0.15), borderRadius: BorderRadius.circular(20)),
                        ...
                        GridView.builder(
                          ...
                          itemBuilder: (context, i) {
                            ...
                            if (_selectedAnswer != -1) {
                              if (i == correct) btnColor = AppColors.accentGreen;
                            ...
                            return GestureDetector(
                              ...
                              child: AnimatedContainer(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: _selectedAnswer != -1 && (i == correct || i == _selectedAnswer) ? btnColor : Colors.white.withOpacity(0.1)),
                                ),
