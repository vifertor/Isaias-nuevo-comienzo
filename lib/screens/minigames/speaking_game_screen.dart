          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [AppColors.speakingColor.withOpacity(0.15), AppColors.darkBg, AppColors.darkBg],
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(color: AppColors.speakingColor.withOpacity(0.2), borderRadius: BorderRadius.circular(14), border: Border.all(color: AppColors.speakingColor.withOpacity(0.4))),
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(colors: [AppColors.speakingColor.withOpacity(0.2), AppColors.darkCard], begin: Alignment.topCenter, end: Alignment.bottomCenter),
                            borderRadius: BorderRadius.circular(28),
                            border: Border.all(color: AppColors.speakingColor.withOpacity(0.4), width: 2),
                          ),
                          child: Column(
                            children: [
                              // Mascot motivator
                              Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(color: AppColors.speakingColor.withOpacity(0.15), borderRadius: BorderRadius.circular(20)),
                                    child: const Row(
                                      children: [
                              ...
                              Text('💡 ${word['tip']}', style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 12, fontWeight: FontWeight.w600)),
                            ],
                          ),
                        ),
                              ...
                              children: [
                                    ...
                                    builder: (context, _) {
                                      return Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          color: AppColors.speakingColor.withOpacity(0.15 * (1 - _rippleAnim.value)),
                                        ),
                                      );
                                    },
                                  ),
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color: (_isRecording ? AppColors.speakingColor : AppColors.primaryPurple).withOpacity(0.5),
                        ...
                        Text(
                          ...
                          style: TextStyle(color: _isRecording ? AppColors.speakingColor : Colors.white.withOpacity(0.5), fontWeight: FontWeight.w700, fontSize: 14),
                        ),
                        if (_showResult) ...[
                          ...
                          AnimatedContainer(
                            ...
                            padding: const EdgeInsets.all(20),
                            decoration: BoxDecoration(
                              color: (_isCorrect ? AppColors.accentGreen : AppColors.accentOrange).withOpacity(0.15),
                              borderRadius: BorderRadius.circular(20),
                              border: Border.all(color: (_isCorrect ? AppColors.accentGreen : AppColors.accentOrange).withOpacity(0.4)),
                            ),
                            child: Column(
                              children: [
              ...
              return AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  gradient: _isRecording
                      ? LinearGradient(colors: [AppColors.speakingColor, AppColors.accentPink], begin: Alignment.topCenter, end: Alignment.bottomCenter)
                      : LinearGradient(colors: [Colors.white.withOpacity(0.15), Colors.white.withOpacity(0.05)], begin: Alignment.topCenter, end: Alignment.bottomCenter),
