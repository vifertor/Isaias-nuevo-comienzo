                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(color: AppColors.accentYellow.withOpacity(0.2), borderRadius: BorderRadius.circular(16), border: Border.all(color: AppColors.accentYellow.withOpacity(0.4))),
                          ...
                          Container(
                            padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                            decoration: BoxDecoration(color: AppColors.primaryCyan.withOpacity(0.2), borderRadius: BorderRadius.circular(16), border: Border.all(color: AppColors.primaryCyan.withOpacity(0.4))),
      ...
      itemBuilder: (context, i) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: a.unlocked ? a.color.withOpacity(0.4) : Colors.white.withOpacity(0.06)),
            boxShadow: a.unlocked ? [BoxShadow(color: a.color.withOpacity(0.15), blurRadius: 12)] : [],
          ),
          child: Row(
            children: [
              Container(
                width: 56, height: 56,
                decoration: BoxDecoration(
                  color: a.unlocked ? a.color.withOpacity(0.2) : Colors.white.withOpacity(0.05),
                  borderRadius: BorderRadius.circular(16),
                  border: Border.all(color: a.unlocked ? a.color.withOpacity(0.5) : Colors.white.withOpacity(0.08)),
                ),
                child: Icon(a.icon, color: a.unlocked ? a.color : Colors.white.withOpacity(0.2), size: 28),
              ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Text(a.title, style: TextStyle(color: a.unlocked ? Colors.white : Colors.white.withOpacity(0.4), fontWeight: FontWeight.w800, fontSize: 14)),
                        if (a.unlocked) ...[const SizedBox(width: 6), const Text('✅', style: TextStyle(fontSize: 12))],
                      ],
                    ),
                    const SizedBox(height: 3),
                    Text(a.description, style: TextStyle(color: Colors.white.withOpacity(0.4), fontSize: 12, fontWeight: FontWeight.w500)),
                  ],
                ),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                  color: AppColors.accentYellow.withOpacity(a.unlocked ? 0.2 : 0.08),
                  borderRadius: BorderRadius.circular(10),
                ),
                child: Text('+${a.xpReward} XP',
                  style: TextStyle(color: a.unlocked ? AppColors.accentYellow : Colors.white.withOpacity(0.3), fontWeight: FontWeight.w800, fontSize: 11)),
              ),
            ],
          ),
        );
      ...
      itemBuilder: (context, i) {
        ...
        return Container(
          decoration: BoxDecoration(
            color: AppColors.darkCard,
            borderRadius: BorderRadius.circular(20),
            border: Border.all(color: color.withOpacity(unlocked ? 0.4 : 0.15)),
            boxShadow: unlocked ? [BoxShadow(color: color.withOpacity(0.2), blurRadius: 12)] : [],
          ),
          child: Column(
            ...
            children: [
              ...
              Text(c['name'] as String, textAlign: TextAlign.center, style: TextStyle(color: unlocked ? Colors.white : Colors.white.withOpacity(0.4), fontWeight: FontWeight.w800, fontSize: 13)),
              const SizedBox(height: 4),
              Text(c['reward'] as String, style: TextStyle(color: color.withOpacity(0.7), fontSize: 11, fontWeight: FontWeight.w600)),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('${c['cost']}', style: TextStyle(color: unlocked ? Colors.white : Colors.white.withOpacity(0.3), fontWeight: FontWeight.w800, fontSize: 12)),
                  ],
                ),
              ),
            ],
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, i) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(color: AppColors.darkCard, borderRadius: BorderRadius.circular(18), border: Border.all(color: color.withOpacity(0.25))),
          child: Row(
            children: [
              Container(
                width: 52, height: 52,
