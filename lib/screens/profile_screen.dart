...
class ProfileScreen extends StatelessWidget {
                ...
                Wrap(
                  ...
                  children: MockData.achievements.map((a) => Container(
                    ...
                    decoration: BoxDecoration(
                      color: a.unlocked ? a.color.withOpacity(0.15) : AppColors.darkCard,
                      borderRadius: BorderRadius.circular(14),
                      border: Border.all(color: a.unlocked ? a.color.withOpacity(0.4) : Colors.white.withOpacity(0.06)),
                    ),
                    child: Icon(a.icon, color: a.unlocked ? a.color : Colors.white.withOpacity(0.2), size: 24),
                  )).toList(),
                ),
  ...
  Widget _buildProfileHeader(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Positioned(right: -40, top: -40, child: Container(width: 180, height: 180, decoration: BoxDecoration(shape: BoxShape.circle, color: AppColors.primaryPurple.withOpacity(0.1)))),
          Padding(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('@${user.username}', style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 13, fontWeight: FontWeight.w600)),
  ...
  Widget _buildWeeklyChart() {
    final days = MockData.weeklyData;
        ...
        children: days.map((d) {
          ...
          return Column(
            children: [
              ...
              Text(d.day, style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 11, fontWeight: FontWeight.w600)),
            ],
          );
        }).toList(),
      ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(a['time']!, style: TextStyle(color: Colors.white.withOpacity(0.4), fontSize: 11)),
              ],
            ),
          ),
          Container(
            padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
            decoration: BoxDecoration(color: AppColors.accentYellow.withOpacity(0.15), borderRadius: BorderRadius.circular(8)),
